...
namespace Stac.Api.Clients.ItemSearch
{
    ...
    public partial class ItemSearchClient : Stac.Api.Clients.StacApiClient
    {
        ...
        public virtual System.Threading.Tasks.Task<SearchResponse> GetItemSearchAsync(string bbox, IntersectsQueryString intersectsQueryString, string datetime, int? limit, System.Collections.Generic.IEnumerable<string> ids, System.Collections.Generic.IEnumerable<string> collections, string fields, string sortby, Stac.Api.WebApi.Controllers.Fragments.Filter.FilterParameter filterParameter)
        {
            return GetItemSearchAsync(bbox, intersectsQueryString, datetime, limit, ids, collections, fields, sortby, filterParameter, System.Threading.CancellationToken.None);
        }
        ...
        /// <returns>A feature collection.</returns>
        /// <exception cref="StacApiException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task<SearchResponse> GetItemSearchAsync(string bbox, IntersectsQueryString intersectsQueryString, string datetime, int? limit, System.Collections.Generic.IEnumerable<string> ids, System.Collections.Generic.IEnumerable<string> collections, string fields, string sortby, Stac.Api.WebApi.Controllers.Fragments.Filter.FilterParameter filterParameter, System.Threading.CancellationToken cancellationToken)
        {
