...
namespace Stac.Api.Clients.Fragments.Filter
{
    ...
    public partial class FragmentsFilterClient : Stac.Api.Clients.StacApiClient
    {
        ...
        /// <exception cref="StacApiException">A server side error occurred.</exception>
        public virtual System.Threading.Tasks.Task<object> GetQueryablesAsync()
        {
        ...
        /// <returns>A JSON Schema defining the Queryables allowed in CQL2 expressions</returns>
        /// <exception cref="StacApiException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task<object> GetQueryablesAsync(System.Threading.CancellationToken cancellationToken)
        {
            var urlBuilder_ = new System.Text.StringBuilder();
                ...
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    try
                    {
                        ...
                        else
                        {
                            ...
                            throw new StacApiException<Response>("An error occurred.", status_, objectResponse_.Text, headers_, objectResponse_.Object, null);
                        }
                    }
                    finally
                    {
        ...
        /// <returns>Collection description</returns>
        /// <exception cref="StacApiException">A server side error occurred.</exception>
        public virtual System.Threading.Tasks.Task CollectionsAsync(string collectionId)
        {
            return CollectionsAsync(collectionId, System.Threading.CancellationToken.None);
        }
        ...
        /// <returns>Collection description</returns>
        /// <exception cref="StacApiException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task CollectionsAsync(string collectionId, System.Threading.CancellationToken cancellationToken)
        {
        ...
        /// <returns>A JSON Schema defining the Queryables allowed in CQL2 expressions</returns>
        /// <exception cref="StacApiException">A server side error occurred.</exception>
        public virtual System.Threading.Tasks.Task<object> GetQueryablesForCollectionAsync(string collectionId)
        {
        ...
        /// <returns>A JSON Schema defining the Queryables allowed in CQL2 expressions</returns>
        /// <exception cref="StacApiException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task<object> GetQueryablesForCollectionAsync(string collectionId, System.Threading.CancellationToken cancellationToken)
        {
            if (collectionId == null)
                throw new System.ArgumentNullException("collectionId");
