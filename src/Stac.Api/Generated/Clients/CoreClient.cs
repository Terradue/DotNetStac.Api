...
namespace Stac.Api.Generated.Clients
{
    ...
    public partial class CoreClient : Stac.Api.StacApiClient
    {
        ...
        public System.Threading.Tasks.Task<LandingPage> GetLandingPageAsync()
        {
    ...
    /// <summary>Information about the exception: an error code plus an optional description.</summary>
